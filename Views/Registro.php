		...
		<form method="POST" class="formulario" id="formulario">
			...
			<div class="formulario__grupo" id="grupo__usuario">
				...
				<div class="formulario__grupo-input">
					<input type="text" class="formulario__input" name="usuario" id="usuario" placeholder="john123" required value="<?php if(isset($User)) echo($User);?>">
			...
			<div class="formulario__grupo" id="grupo__nombre">
				...
				<div class="formulario__grupo-input">
					<input type="text" class="formulario__input" name="nombre" id="nombre" placeholder="John Doe" required value="<?php if(isset($Nombre)) echo($Nombre);?>">
					<i class="formulario__validacion-estado fas fa-times-circle"></i>
				</div>
				<p class="formulario__input-error">El usuario tiene que ser de 4 a 16 dígitos y solo puede contener numeros, letras y guion bajo.</p>
			</div>
			...
			<div class="formulario__grupo" id="grupo__password">
				...
				<div class="formulario__grupo-input">
					<input type="password" class="formulario__input" name="password" id="password" required value="<?php if(isset($Password)) echo($Password);?>">
					<i class="formulario__validacion-estado fas fa-times-circle"></i>
				</div>
			...
			<div class="formulario__grupo" id="grupo__password2">
				...
				<div class="formulario__grupo-input">
					<input type="password" class="formulario__input" name="password2" id="password2" required value="<?php if(isset($Password2)) echo($Password2);?>">
					<i class="formulario__validacion-estado fas fa-times-circle"></i>
				</div>
			...
			<div class="formulario__grupo" id="grupo__correo">
				...
				<div class="formulario__grupo-input">
					<input type="email" class="formulario__input" name="correo" id="correo" placeholder="correo@correo.com" required value="<?php if(isset($Email)) echo($Email);?>">
					<i class="formulario__validacion-estado fas fa-times-circle"></i>
				</div>
				<?php if(isset($_POST['Btn_Registrar'])) {?>
			...
			<div class="formulario__grupo" id="grupo__telefono">
				...
				<div class="formulario__grupo-input">
					<input type="text" class="formulario__input" name="telefono" id="telefono" placeholder="4491234567" required value="<?php if(isset($Telefono)) echo($Telefono);?>">
					<i class="formulario__validacion-estado fas fa-times-circle"></i>
				</div>
